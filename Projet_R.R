...
#A-Imports and exports ( correlation >0.5)
...
#B-Life Expectancy and GDP Per Capita ( correlation>0.5)
...
#C-Poverty and GDP Per Capita (correlation <-0.5)
...
#D-Poverty and Life expectancy (correlation <-0.5)
library(ggplot2)
# Scatter plot with trend line for China
...
# Same work for colomn Inflation
library(base)
